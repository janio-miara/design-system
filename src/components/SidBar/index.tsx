...
export const SidBar = () => {
  ...
  return (
    <Style.Container open={open} onClick={() => setOpen(!open)} onMouseOver={() => setOpen(true)}>
      <div className="logo">
        <img src={!open ? logoWavecode : logo} alt="logo" />
      </div>
      <div className="wrapperContainer">
        {side.map(side => (
          <Modulo side={side} open={open} setActive={setActive} active={active} />
        ))}
      </div>
    </Style.Container>
  )
